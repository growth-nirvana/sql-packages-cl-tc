...
{% assign dimensions = vars.google_ads_grant.models.google_ad_grant__campaign_report_custom_conversions.dimensions %}
{% assign metrics = vars.google_ads_grant.models.google_ad_grant__campaign_report_custom_conversions.metrics %}
{% assign account_id = vars.google_ads_grant.account_ids %}
{% assign active = vars.google_ads_grant.active %}
{% assign table_active = vars.google_ads_grant.models.google_ad_grant__campaign_report_custom_conversions.active %}
{% assign dataset_id = vars.output_dataset_id %}
{% assign table_id = vars.google_ads_grant.models.google_ad_grant__campaign_report_custom_conversions.table_id %}
{% assign source_table_id = vars.google_ads_grant.models.google_ad_grant__campaign_report_custom_conversions.source_table_id %}
