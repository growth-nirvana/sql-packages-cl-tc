{% assign dimensions = vars.google_ads_search.models.google_commercial_search__campaign_report.dimensions %}
{% assign metrics = vars.google_ads_search.models.google_commercial_search__campaign_report.metrics %}
{% assign account_id = vars.google_ads_search.account_ids %}
{% assign active = vars.google_ads_search.active %}
{% assign table_active = vars.google_ads_search.models.google_commercial_search__campaign_report.active %}
{% assign dataset_id = vars.output_dataset_id %}
{% assign table_id = vars.google_ads_search.models.google_commercial_search__campaign_report.table_id %}
{% assign source_table_id = vars.google_ads_search.models.google_commercial_search__campaign_report.source_table_id %}
...
{% assign ad_group_delimiter = vars.google_ads_search.delimiters.ad_group %}
{% assign campaign_delimiter = vars.google_ads_search.delimiters.campaign %}
