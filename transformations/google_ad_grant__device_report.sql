...
*/
{% assign dimensions = vars.google_ads_grant.models.google_ad_grant__device_report.dimensions %}
{% assign metrics = vars.google_ads_grant.models.google_ad_grant__device_report.metrics %}
{% assign account_id = vars.google_ads_grant.account_ids %}
{% assign active = vars.google_ads_grant.active %}
{% assign table_active = vars.google_ads_grant.models.google_ad_grant__device_report.active %}
{% assign dataset_id = vars.output_dataset_id %}
{% assign table_id = 'google_ad_grant__device_report' %}
