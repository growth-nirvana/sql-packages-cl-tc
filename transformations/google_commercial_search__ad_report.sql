{% assign dimensions = vars.google_ads_search.models.google_commercial_search__ad_report.dimensions %}
{% assign metrics = vars.google_ads_search.models.google_commercial_search__ad_report.metrics %}
{% assign account_id = vars.google_ads_search.account_ids %}
{% assign active = vars.google_ads_search.active %}
{% assign table_active = vars.google_ads_search.models.google_commercial_search__ad_report.active %}
{% assign dataset_id = vars.output_dataset_id %}
{% assign table_id = vars.google_ads_search.models.google_commercial_search__ad_report.table_id %}
